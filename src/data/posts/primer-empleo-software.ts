...
export const primerEmpleoSoftwarePost: BlogPost = {
    ...
    body: [
        ...
        {
            type: 'h2',
            text: 'La experiencia no empieza cuando una empresa te contrata',
        },
        {
            type: 'p',
        ...
        {
            type: 'h2',
            text: 'Cuando buscar trabajo dejó de ser opcional',
        },
        {
            type: 'p',
        ...
        {
            type: 'h2',
            text: 'No necesitas mentir para vender tu perfil',
        },
        {
            type: 'p',
        ...
        {
            type: 'p',
            text: 'El desarrollo no es la única forma de comenzar.',
        },
        {
            type: 'p',
        ...
        {
            type: 'h2',
            text: 'Tu primera oportunidad puede llegar',
        },
        {
            type: 'p',
        ...
        {
            type: 'p',
            text: 'La fe no reemplaza la preparación. La acompaña.',
        },
        {
            type: 'p',
