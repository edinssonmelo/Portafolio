...
export const HeroImage = () => {
  return (
    <div className="relative shrink-0 w-full max-w-[340px] mx-auto min-h-[320px] overflow-visible md:aspect-[0.845455_/_1] md:min-h-0 md:max-w-none md:mx-0 md:w-[620px]">
      <BlurEllipses ellipses={heroEllipses} />
      <div className="absolute z-10 content-center items-center flex shrink-0 h-[228px] justify-center left-1/2 -translate-x-1/2 w-[228px] rounded-full top-1/2 -translate-y-1/2 md:h-[280px] md:w-[280px] md:rounded-[185px] md:left-[calc(50.084%_-_140px)] md:top-[calc(47.4432%_-_140px)] md:translate-x-0 md:translate-y-0 after:absolute after:inset-0 after:rounded-full md:after:rounded-[185px] after:border-2 after:border-neutral-800 after:pointer-events-none">
        <div className="absolute inset-0 rounded-full md:rounded-[185px] overflow-hidden">
          <img
            sizes="(max-width: 768px) 228px, 280px"
            src="/assets/hero.png"
            alt="Edinsson Melo"
