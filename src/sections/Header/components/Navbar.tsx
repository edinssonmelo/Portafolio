...
export const Navbar = () => {
  ...
  return (
    ...
    >
      <div className="relative mx-auto max-w-[1140px] opacity-100">
        <div className="opacity-100">
          <div className="flex items-center justify-between px-3 py-2.5 pr-12 opacity-100 md:h-[84px] md:px-0 md:py-0 md:pr-10">
            <div className="opacity-100">
              <Logo />
            </div>
      ...
      <div className="absolute right-4 top-1/2 z-10 -translate-y-1/2 md:right-[30px]">
        <LanguageSwitcher />
      </div>
