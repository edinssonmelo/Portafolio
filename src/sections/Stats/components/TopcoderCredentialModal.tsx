...
type TopcoderCredentialModalProps = {
    onClose: () => void;
};

export const TopcoderCredentialModal = ({ onClose }: TopcoderCredentialModalProps) => {
    ...
    const modal = (
        <div className="fixed inset-0 z-[9998]">
            <button
                ...
                aria-label={t('credentials.topcoderTco19.modal.close')}
                onClick={onClose}
            />
            ...
            >
                <div
                    ...
                    role="dialog"
                    aria-modal="true"
                    aria-labelledby="topcoder-modal-title"
                ...
                >
                    ...
                    <SurfaceCard className="overflow-hidden">
                        <div className="overflow-hidden border-b-2 border-stone-900 bg-stone-100">
                            <img
                                src={versionedSrc('/assets/credentials/tco19-topcoder-cover.png')}
                                alt=""
                                className="h-[150px] w-full object-cover object-[center_72%] md:h-[210px] md:object-[center_58%] lg:h-[225px] lg:object-[center_55%]"
                            />
                        </div>
                            ...
                            <div className="flex justify-center pt-0.5 md:pt-1">
                                ...
                                >
                                    <span className="font-dm_sans text-sm font-semibold text-stone-900 md:text-base">
                                        {t('credentials.topcoderTco19.modal.viewProfile')}
                                    </span>
                                </GradientButton>
                            </div>
                        </div>
