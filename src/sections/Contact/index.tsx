...
export const Contact = () => {
  return (
    <section id="contact" className="relative content-center items-center bg-neutral-100 box-border caret-transparent gap-x-2.5 flex shrink-0 h-min justify-center gap-y-2.5 w-full overflow-hidden pt-[100px] px-[30px] scroll-mt-10 md:pt-[150px] md:scroll-mt-0">
      <div className="relative content-center items-center box-border caret-transparent gap-x-[90px] flex basis-0 flex-col grow shrink-0 h-min justify-end max-w-[1140px] gap-y-[90px] w-full">
        ...
        <div className="hidden md:absolute md:aspect-auto md:box-border md:caret-transparent md:shrink-0 md:h-[85px] md:overscroll-x-auto md:overscroll-y-auto md:pointer-events-none md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:top-[-169px] md:w-[46px] md:z-[1] md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto] md:-right-9">
        ...
        <div className="hidden md:absolute md:aspect-auto md:box-border md:caret-transparent md:shrink-0 md:h-16 md:left-[-19px] md:overscroll-x-auto md:overscroll-y-auto md:pointer-events-none md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:top-[calc(52.3427%_-_32px)] md:w-[65px] md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto]">
        ...
        <div className="hidden md:absolute md:aspect-auto md:box-border md:caret-transparent md:shrink-0 md:h-[38px] md:overscroll-x-auto md:overscroll-y-auto md:pointer-events-none md:right-[-29px] md:snap-align-none md:snap-normal md:snap-none md:decoration-auto md:underline-offset-auto md:w-[89px] md:[mask-position:0%] md:bg-left-top md:scroll-m-0 md:scroll-p-[auto] md:bottom-[274px]">
